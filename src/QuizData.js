export const QuizData = [
  {
    id: 0,
    question:
      "Do you consider yourself a Star Wars fan? (does not count towards final score)",
  ...
  },
  {
    id: 3,
    question:
      "What did Jar Jar Binks end up owing Qui-Gon Jinn after being rescued by the same during the invasion of Naboo?",
    options: [
  ...
  },
  {
    ...
    options: ["Blaster Riffle", "Lightsaber", "Metal Club", "Bowcaster"],
    answer: "Bowcaster",
  },
  {
    id: 5,
    ...
    options: ["Darth Vader", "Darth Brooks", "Darth Maul", "Darth Paul"],
    answer: "Darth Maul",
  },
  {
    id: 6,
    ...
    options: ["Ewoks", "Wookies", "Nerf Herders", "Jawas"],
    answer: "Ewoks",
  },
  {
    id: 7,
    question: "Who adopted Padmé Amidala’s daughter?",
    options: [
      "Captian Antilles",
      "Bail Organa",
      "Owen and Beru Lars",
  ...
  {
    id: 8,
    question: "What is Admiral Ackbar’s famous phrase?",
    options: [
      "Thats a good wrap",
      "Run!",
      "Its a trap!",
  ...
  },
  {
    ...
    options: ["Pilot", "Gaurd", "Chef", "Sanitation"],
    answer: "Sanitation",
  },
  {
    id: 10,
  ...
  },
  {
    ...
    options: ["Chewbacca", "Boba Fett", "Darth Vader", "Yoda"],
    answer: "Darth Vader",
  },
  {
    id: 18,
    question: "Bo-Katan wanted what from Moff Gideon in The Mandalorian?",
    options: ["Credits", "The Darksaber", "Location of Thrawn", "His armor"],
